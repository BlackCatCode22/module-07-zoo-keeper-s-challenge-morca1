...
class Tiger(Animal):
    ...
    list_of_tiger_names = [Tony, Tigger, Amber, Cosimia, Cuddles, Dave, Jiba, Rajah, Rayas, Ryker]
    ...
    def __init__(self, name="a_name", animal_id="an_id", birth_date="2099-01-01", color="a_color", sex="a_sex",
        ...
        # Increment the static variable numOfLions when a new Tiger object is created
        Tiger.numOfTiger += 1
