...
class Bear(Animal):
    ...
    list_of_bear_names = [Yogi, Smokey, Paddington, Lippy, Bungle, Baloo, Rupert, Winnie the Pooh, Snuggles, Bert]
    ...
    def __init__(self, name="a_name", animal_id="an_id", birth_date="2099-01-01", color="a_color", sex="a_sex",
        ...
        # Increment the static variable numOfBears when a new Bears object is created
        Bear.numOfBears += 1
